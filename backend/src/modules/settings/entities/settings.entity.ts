...
/**
 * Global application preferences (singleton row, `id = 1`), independent of
 * any connection (RG-019-23) — the GitLab URL/token/username moved to
 * `Connection` in US-019. Columns are added by each user story through
